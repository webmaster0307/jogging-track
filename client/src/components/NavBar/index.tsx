...
class NavBar extends React.Component<INavProps, INavState>{
  ...
  public render() {
    const { activeLanguage, activeTheme, classes, languages, isAuthenticated } = this.props;
      ...
      <div className={classes.toolbar}>
        <List onClick={this.handleDrawerToggle}>
          <ListItem button={true}>
            <ListItemText primary="Authentication Menu" />
          </ListItem>
          <Divider />
          <ListItem>
            <NavLink
      ...
      <div className={classes.root}>
        <AppBar position="static">
          <Toolbar variant="dense">
            ...
            <Hidden smDown={true} className={classes.flex}>
              {isAuthenticated ? navLinks : authLinks}
            </Hidden>
            <IconButton
              color="inherit"
        ...
        <Hidden mdUp={true}>
          <Drawer
            ...
            {isAuthenticated ? sideNavLinks : sideAuthLinks}
          </Drawer>
        </Hidden>
      </div>
    );
