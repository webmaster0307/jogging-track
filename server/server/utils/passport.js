...
passport.use('googleToken', new GooglePlusTokenStrategy({
  clientID: PassportConfig.oauth.google.clientID,
  clientSecret: PassportConfig.oauth.google.clientSecret,
...
passport.use('facebookToken', new FacebookTokenStrategy({
  clientID: PassportConfig.oauth.facebook.clientID,
  clientSecret: PassportConfig.oauth.facebook.clientSecret
}, async (accessToken, refreshToken, profile, done) => {
  try {
    console.log('profile', profile);
    console.log('accessToken', accessToken);
